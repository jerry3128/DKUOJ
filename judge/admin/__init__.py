...
from judge.admin.ai_hints import AIHintLogAdmin
...
from judge.models import AIHintLog, BlogPost, Class, Comment, CommentLock, Contest, ContestParticipation, \
    ContestTag, Judge, Language, License, MiscConfig, NavigationBar, Organization, \
    OrganizationRequest, Problem, ProblemGroup, ProblemPointsVote, ProblemType, Profile, Submission, Ticket

admin.site.register(AIHintLog, AIHintLogAdmin)
