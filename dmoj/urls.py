...
urlpatterns = [
    ...
    path('problem/create', problem.SimplifiedProblemCreate.as_view(), name='problem_create'),
    ...
    path('submission/<int:submission>', include([
        ...
        path('/ai-hint', submission.SubmissionAIHint.as_view(), name='submission_ai_hint'),
    ])),
    ...
    path('contest/<str:contest>', include([
        ...
        path('/export-word/', contests.ContestExportWord.as_view(), name='contest_export_word'),
